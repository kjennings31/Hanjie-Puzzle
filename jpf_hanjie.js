...
// run init fucnt when page loads 
window.onload = init; 
function init() {
	...
	//insert the html code for first puzzle table
...
function swapPuzzle(e) {
	...
	document.getElementById("puzzleTitle").innerHTML = puzzleTitle; 
		...
		case "puzzle2":
			...
			break; 
		case "puzzle3":
			doucment.getElementById("puzzle").innerHTML = drawPuzzle(puzzle3Hint,puzzle3Rating,Puzzle3) 
			break; 
...
//match all of teh data cells in puzzle 
...
function setBackground(e) {
	...
	// set background based on keyboard key 
		if (e.shiftKey) {
